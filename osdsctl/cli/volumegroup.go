...
func init() {
	...
	volumeGroupListCommand.Flags().StringVarP(&vgCreatedAt, "createdAt", "", "", "list volume group by created time")
	volumeGroupListCommand.Flags().StringVarP(&vgUpdatedAt, "updatedAt", "", "", "list volume group by updated time")
