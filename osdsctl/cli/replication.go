...
func init() {
	...
	replicationListCommand.Flags().StringVarP(&repCreatedAt, "createdAt", "", "", "list replication by created time")
	replicationListCommand.Flags().StringVarP(&repName, "name", "", "", "list replication by name")
	replicationListCommand.Flags().StringVarP(&repUpdatedAt, "updatedAt", "", "", "list replication by updated time")
