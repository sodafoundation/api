...
func ListVersions() (api.AvailableVersions, error) {
	var aVersions api.AvailableVersions
	err := json.Unmarshal([]byte(KnownVersions), &aVersions)
	if err != nil {
		log.Println(err)
		return api.AvailableVersions{}, err
	}
	return aVersions, nil
}

func GetVersionv1() (api.VersionInfo, error) {
