...
type ShareRequest struct {
	Schema  *api.ShareOperationSchema `json:"schema"`
	Profile *api.StorageProfile       `json:"profile"`
}

func (sr ShareRequest) createShare() *pb.Response {
	return grpcapi.CreateShare(sr.Schema, sr.Profile)
}

func (sr ShareRequest) getShare() *pb.Response {
	return grpcapi.GetShare(sr.Schema, sr.Profile)
}

func (sr ShareRequest) listShares() *pb.Response {
	return grpcapi.ListShares(sr.Schema, sr.Profile)
}

func (sr ShareRequest) deleteShare() *pb.Response {
	return grpcapi.DeleteShare(sr.Schema, sr.Profile)
}

func (sr ShareRequest) attachShare() *pb.Response {
	return grpcapi.AttachShare(sr.Schema, sr.Profile)
}

func (sr ShareRequest) detachShare() *pb.Response {
	return grpcapi.DetachShare(sr.Schema, sr.Profile)
}

func (sr ShareRequest) mountShare() *pb.Response {
	return grpcapi.MountShare(sr.Schema, sr.Profile)
}

func (sr ShareRequest) unmountShare() *pb.Response {
	return grpcapi.UnmountShare(sr.Schema, sr.Profile)
}
