...
func RegisterAsynchronizedWorkflow(vr *pb.VolumeRequest, tags map[string]string, in string) (AsynchronizedWorkflow, error) {
...
func RegisterSynchronizedWorkflow(vr *pb.VolumeRequest, tags map[string]string) (SynchronizedWorkflow, error) {
