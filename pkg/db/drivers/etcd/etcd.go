...
// GetDocks
func (c *Client) GetDocks() ([]*model.DockSpec, error) {
	dbReq := &Request{
...
func (c *Client) ListDocks(m map[string][]string) ([]*model.DockSpec, error) {
	docks, err := c.GetDocks()
	if err != nil {
...
func (c *Client) ListPools(m map[string][]string) ([]*model.StoragePoolSpec, error) {
...
// ListPools
func (c *Client) GetPools() ([]*model.StoragePoolSpec, error) {
	dbReq := &Request{
...
// ListProfiles
func (c *Client) GetProfiles() ([]*model.ProfileSpec, error) {
	dbReq := &Request{
...
func (c *Client) ListProfiles(m map[string][]string) ([]*model.ProfileSpec, error) {
	profiles, err := c.GetProfiles()
	if err != nil {
...
// GetVolumes
func (c *Client) GetVolumes() ([]*model.VolumeSpec, error) {
	dbReq := &Request{
...
func (c *Client) ListVolumes(m map[string][]string) ([]*model.VolumeSpec, error) {
...
func (c *Client) GetVolumeAttachments(volumeId string) ([]*model.VolumeAttachmentSpec, error) {
	dbReq := &Request{
...
func (c *Client) ListVolumeAttachments(m map[string][]string) ([]*model.VolumeAttachmentSpec, error) {
	volumeId := m["VolumeId"][0]
	volumeAttachments, err := c.GetVolumeAttachments(volumeId)
	if err != nil {
		log.Error("List volumes failed: ", err)
		return nil, err
	}
...
// ListVolumeSnapshots
func (c *Client) GetVolumeSnapshots() ([]*model.VolumeSnapshotSpec, error) {
	dbReq := &Request{
...
func (c *Client) ListVolumeSnapshots(m map[string][]string) ([]*model.VolumeSnapshotSpec, error) {
	volumeSnapshots, err := c.GetVolumeSnapshots()
	if err != nil {
