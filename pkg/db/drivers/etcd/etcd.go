...
func (c *Client) ListDocksWithFilter(m map[string][]string) ([]*model.DockSpec, error) {
	docks, err := c.ListDocks()
	if err != nil {
...
func (c *Client) ListPoolsWithFilter(m map[string][]string) ([]*model.StoragePoolSpec, error) {
...
func (c *Client) ListProfilesWithFilter(m map[string][]string) ([]*model.ProfileSpec, error) {
	profiles, err := c.ListProfiles()
	if err != nil {
...
func (c *Client) ListVolumesWithFilter(m map[string][]string) ([]*model.VolumeSpec, error) {
...
func (c *Client) ListVolumeAttachmentsWithFilter(m map[string][]string) ([]*model.VolumeAttachmentSpec, error) {
	volumeId := m["VolumeId"][0]
	volumeAttachments, err := c.ListVolumeAttachments(volumeId)
	if err != nil {
		log.Error("List volumes failed: ", err)
		return nil, err
	}
...
func (c *Client) ListVolumeSnapshotsWithFilter(m map[string][]string) ([]*model.VolumeSnapshotSpec, error) {
	volumeSnapshots, err := c.ListVolumeSnapshots()
	if err != nil {
