...
func TestListVolumes(t *testing.T) {
	...
	mockClient.On("ListVolumes", m).Return(fakeVolumes, nil)
	db.C = mockClient
...
func TestListVolumesWithBadRequest(t *testing.T) {
	...
	mockClient.On("ListVolumes", m).Return(nil, errors.New("db error"))
	db.C = mockClient
...
func TestListVolumeSnapshots(t *testing.T) {
	...
	mockClient.On("ListVolumeSnapshots", m).Return(fakeSnapshots, nil)
	db.C = mockClient
...
func TestListVolumeSnapshotsWithBadRequest(t *testing.T) {
	...
	mockClient.On("ListVolumeSnapshots", m).Return(nil, errors.New("db error"))
	db.C = mockClient
...
func TestListVolumeAttachments(t *testing.T) {
	...
	mockClient.On("ListVolumeAttachments", m).Return(fakeAttachments, nil)
	db.C = mockClient
