...
func (fvr *FakeVolumeRequest) createVolumeSnapshot() *pb.Response {
	return &pb.Response{
		Status:  "Success",
		Message: sampleVolumeData,
	}
...
func (fvr *FakeVolumeRequest) getVolumeSnapshot() *pb.Response {
	return &pb.Response{
		Status:  "Success",
		Message: sampleVolumeDetailData,
	}
...
func (fvr *FakeVolumeRequest) listVolumeSnapshots() *pb.Response {
	return &pb.Response{
		Status:  "Success",
		Message: sampleVolumesData,
	}
...
func (fvr *FakeVolumeRequest) deleteVolumeSnapshot() *pb.Response {
	return &pb.Response{
		Status:  "Success",
		Message: "Delete volume success!",
	}
