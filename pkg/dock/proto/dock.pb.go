...
func (*CreateVolumeOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{0}
}
...
func (*DeleteVolumeOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{1}
}
...
func (*ExtendVolumeOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{2}
}
...
func (*CreateVolumeSnapshotOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{3}
}
...
func (*DeleteVolumeSnapshotOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{4}
}
...
func (m *CreateAttachmentOpts) String() string { return proto.CompactTextString(m) }
func (*CreateAttachmentOpts) ProtoMessage()    {}
func (*CreateAttachmentOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{5}
}
func (m *CreateAttachmentOpts) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_CreateAttachmentOpts.Unmarshal(m, b)
}
func (m *CreateAttachmentOpts) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_CreateAttachmentOpts.Marshal(b, m, deterministic)
}
func (dst *CreateAttachmentOpts) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CreateAttachmentOpts.Merge(dst, src)
}
func (m *CreateAttachmentOpts) XXX_Size() int {
	return xxx_messageInfo_CreateAttachmentOpts.Size(m)
}
func (m *CreateAttachmentOpts) XXX_DiscardUnknown() {
	xxx_messageInfo_CreateAttachmentOpts.DiscardUnknown(m)
}

var xxx_messageInfo_CreateAttachmentOpts proto.InternalMessageInfo
...
func (m *DeleteAttachmentOpts) String() string { return proto.CompactTextString(m) }
func (*DeleteAttachmentOpts) ProtoMessage()    {}
func (*DeleteAttachmentOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{6}
}
func (m *DeleteAttachmentOpts) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_DeleteAttachmentOpts.Unmarshal(m, b)
}
func (m *DeleteAttachmentOpts) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_DeleteAttachmentOpts.Marshal(b, m, deterministic)
}
func (dst *DeleteAttachmentOpts) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeleteAttachmentOpts.Merge(dst, src)
}
func (m *DeleteAttachmentOpts) XXX_Size() int {
	return xxx_messageInfo_DeleteAttachmentOpts.Size(m)
}
func (m *DeleteAttachmentOpts) XXX_DiscardUnknown() {
	xxx_messageInfo_DeleteAttachmentOpts.DiscardUnknown(m)
}

var xxx_messageInfo_DeleteAttachmentOpts proto.InternalMessageInfo
...
func (*CreateSnapshotAttachmentOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{7}
}
...
func (*DeleteSnapshotAttachmentOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{8}
}
...
func (*HostInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{9}
}
...
func (*VolumeData) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{10}
}
...
func (*CreateReplicationOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{11}
}
...
func (*DeleteReplicationOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{12}
}
...
func (*EnableReplicationOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{13}
}
...
func (*DisableReplicationOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{14}
}
...
func (*FailoverReplicationOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{15}
}
...
func (*CreateVolumeGroupOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{16}
}
...
func (*UpdateVolumeGroupOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{17}
}
...
func (*DeleteVolumeGroupOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{18}
}
...
func (*AttachVolumeOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{19}
}
...
func (*DetachVolumeOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{20}
}
...
func (*GenericResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{21}
}
...
func (*GenericResponse_Result) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{21, 0}
}
...
func (*GenericResponse_Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_dock_3a8186492a398791, []int{21, 1}
}
...
func init() {
	...
	proto.RegisterType((*CreateAttachmentOpts)(nil), "proto.CreateAttachmentOpts")
	proto.RegisterMapType((map[string]string)(nil), "proto.CreateAttachmentOpts.MetadataEntry")
	proto.RegisterType((*DeleteAttachmentOpts)(nil), "proto.DeleteAttachmentOpts")
	proto.RegisterMapType((map[string]string)(nil), "proto.DeleteAttachmentOpts.MetadataEntry")
...
func (c *provisionDockClient) CreateAttachment(ctx context.Context, in *CreateAttachmentOpts, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ProvisionDock/CreateAttachment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *provisionDockClient) DeleteAttachment(ctx context.Context, in *DeleteAttachmentOpts, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ProvisionDock/DeleteAttachment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() { proto.RegisterFile("dock.proto", fileDescriptor_dock_3a8186492a398791) }

var fileDescriptor_dock_3a8186492a398791 = []byte{
