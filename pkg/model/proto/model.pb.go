...
type CreateVolumeAttachmentOpts struct {
	...
	Context string `protobuf:"bytes,9,opt,name=context,proto3" json:"context,omitempty"`
	// The protocol
	AccessProtocol       string   `protobuf:"bytes,10,opt,name=AccessProtocol,json=accessProtocol,proto3" json:"AccessProtocol,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type DeleteVolumeAttachmentOpts struct {
	...
	// The protocol
	AccessProtocol       string   `protobuf:"bytes,8,opt,name=AccessProtocol,json=accessProtocol,proto3" json:"AccessProtocol,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type CreateSnapshotAttachmentOpts struct {
	...
	// The protocol
	AccessProtocol       string   `protobuf:"bytes,9,opt,name=AccessProtocol,json=accessProtocol,proto3" json:"AccessProtocol,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type DeleteSnapshotAttachmentOpts struct {
	...
	Context string `protobuf:"bytes,6,opt,name=context,proto3" json:"context,omitempty"`
	// The protocol
	AccessProtocol       string   `protobuf:"bytes,7,opt,name=AccessProtocol,json=accessProtocol,proto3" json:"AccessProtocol,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type CreateReplicationOpts struct {
	...
	ReplicationPeriod int64 `protobuf:"varint,20,opt,name=ReplicationPeriod,json=replicationPeriod,proto3" json:"ReplicationPeriod,omitempty"`
	// replication bandwidth
	ReplicationBandwidth int64 `protobuf:"varint,21,opt,name=ReplicationBandwidth,json=replicationBandwidth,proto3" json:"ReplicationBandwidth,omitempty"`
	// The Serialized profile
...
func (*CollectMetricsOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_d10048d769ba1c4e, []int{30}
}
...
func (*NoParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_d10048d769ba1c4e, []int{31}
}
...
var fileDescriptor_d10048d769ba1c4e = []byte{
	...
	,
}
...
// ApiControllerClient is the client API for ApiController service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type ApiControllerClient interface {
	// Create a volume
	CreateDockVolume(ctx context.Context, in *CreateVolumeOpts, opts ...grpc.CallOption) (*GenericResponse, error)
	// Delete a volume
	DeleteDockVolume(ctx context.Context, in *DeleteVolumeOpts, opts ...grpc.CallOption) (*GenericResponse, error)
	// Extend a volume
...
type apiControllerClient struct {
	cc grpc.ClientConnInterface
}

func NewApiControllerClient(cc grpc.ClientConnInterface) ApiControllerClient {
	return &apiControllerClient{cc}
}

func (c *apiControllerClient) CreateDockVolume(ctx context.Context, in *CreateVolumeOpts, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ApiController/CreateDockVolume", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiControllerClient) DeleteDockVolume(ctx context.Context, in *DeleteVolumeOpts, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ApiController/DeleteDockVolume", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiControllerClient) ExtendVolume(ctx context.Context, in *ExtendVolumeOpts, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ApiController/ExtendVolume", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiControllerClient) CreateVolumeSnapshot(ctx context.Context, in *CreateVolumeSnapshotOpts, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ApiController/CreateVolumeSnapshot", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiControllerClient) DeleteVolumeSnapshot(ctx context.Context, in *DeleteVolumeSnapshotOpts, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ApiController/DeleteVolumeSnapshot", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiControllerClient) CreateVolumeAttachment(ctx context.Context, in *CreateVolumeAttachmentOpts, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ApiController/CreateVolumeAttachment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiControllerClient) DeleteVolumeAttachment(ctx context.Context, in *DeleteVolumeAttachmentOpts, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ApiController/DeleteVolumeAttachment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiControllerClient) CreateReplication(ctx context.Context, in *CreateReplicationOpts, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ApiController/CreateReplication", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiControllerClient) DeleteReplication(ctx context.Context, in *DeleteReplicationOpts, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ApiController/DeleteReplication", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiControllerClient) EnableReplication(ctx context.Context, in *EnableReplicationOpts, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ApiController/EnableReplication", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiControllerClient) DisableReplication(ctx context.Context, in *DisableReplicationOpts, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ApiController/DisableReplication", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiControllerClient) FailoverReplication(ctx context.Context, in *FailoverReplicationOpts, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ApiController/FailoverReplication", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiControllerClient) CreateVolumeGroup(ctx context.Context, in *CreateVolumeGroupOpts, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ApiController/CreateVolumeGroup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiControllerClient) UpdateVolumeGroup(ctx context.Context, in *UpdateVolumeGroupOpts, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ApiController/UpdateVolumeGroup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiControllerClient) DeleteVolumeGroup(ctx context.Context, in *DeleteVolumeGroupOpts, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ApiController/DeleteVolumeGroup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiControllerClient) GetMetrics(ctx context.Context, in *GetMetricsOpts, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ApiController/GetMetrics", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiControllerClient) CollectMetrics(ctx context.Context, in *CollectMetricsOpts, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ApiController/CollectMetrics", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiControllerClient) GetUrls(ctx context.Context, in *NoParams, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ApiController/GetUrls", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// ApiControllerServer is the server API for ApiController service.
type ApiControllerServer interface {
	// Create a volume
	CreateDockVolume(context.Context, *CreateVolumeOpts) (*GenericResponse, error)
	// Delete a volume
	DeleteDockVolume(context.Context, *DeleteVolumeOpts) (*GenericResponse, error)
	// Extend a volume
...
// UnimplementedApiControllerServer can be embedded to have forward compatible implementations.
type UnimplementedApiControllerServer struct {
}

func (*UnimplementedApiControllerServer) CreateDockVolume(ctx context.Context, req *CreateVolumeOpts) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateDockVolume not implemented")
}
func (*UnimplementedApiControllerServer) DeleteDockVolume(ctx context.Context, req *DeleteVolumeOpts) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteDockVolume not implemented")
}
func (*UnimplementedApiControllerServer) ExtendVolume(ctx context.Context, req *ExtendVolumeOpts) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ExtendVolume not implemented")
}
func (*UnimplementedApiControllerServer) CreateVolumeSnapshot(ctx context.Context, req *CreateVolumeSnapshotOpts) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateVolumeSnapshot not implemented")
}
func (*UnimplementedApiControllerServer) DeleteVolumeSnapshot(ctx context.Context, req *DeleteVolumeSnapshotOpts) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteVolumeSnapshot not implemented")
}
func (*UnimplementedApiControllerServer) CreateVolumeAttachment(ctx context.Context, req *CreateVolumeAttachmentOpts) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateVolumeAttachment not implemented")
}
func (*UnimplementedApiControllerServer) DeleteVolumeAttachment(ctx context.Context, req *DeleteVolumeAttachmentOpts) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteVolumeAttachment not implemented")
}
func (*UnimplementedApiControllerServer) CreateReplication(ctx context.Context, req *CreateReplicationOpts) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateReplication not implemented")
}
func (*UnimplementedApiControllerServer) DeleteReplication(ctx context.Context, req *DeleteReplicationOpts) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteReplication not implemented")
}
func (*UnimplementedApiControllerServer) EnableReplication(ctx context.Context, req *EnableReplicationOpts) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EnableReplication not implemented")
}
func (*UnimplementedApiControllerServer) DisableReplication(ctx context.Context, req *DisableReplicationOpts) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DisableReplication not implemented")
}
func (*UnimplementedApiControllerServer) FailoverReplication(ctx context.Context, req *FailoverReplicationOpts) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FailoverReplication not implemented")
}
func (*UnimplementedApiControllerServer) CreateVolumeGroup(ctx context.Context, req *CreateVolumeGroupOpts) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateVolumeGroup not implemented")
}
func (*UnimplementedApiControllerServer) UpdateVolumeGroup(ctx context.Context, req *UpdateVolumeGroupOpts) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateVolumeGroup not implemented")
}
func (*UnimplementedApiControllerServer) DeleteVolumeGroup(ctx context.Context, req *DeleteVolumeGroupOpts) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteVolumeGroup not implemented")
}
func (*UnimplementedApiControllerServer) GetMetrics(ctx context.Context, req *GetMetricsOpts) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMetrics not implemented")
}
func (*UnimplementedApiControllerServer) CollectMetrics(ctx context.Context, req *CollectMetricsOpts) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CollectMetrics not implemented")
}
func (*UnimplementedApiControllerServer) GetUrls(ctx context.Context, req *NoParams) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUrls not implemented")
}

func RegisterApiControllerServer(s *grpc.Server, srv ApiControllerServer) {
	s.RegisterService(&_ApiController_serviceDesc, srv)
}

func _ApiController_CreateDockVolume_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateVolumeOpts)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiControllerServer).CreateDockVolume(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ApiController/CreateDockVolume",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiControllerServer).CreateDockVolume(ctx, req.(*CreateVolumeOpts))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiController_DeleteDockVolume_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteVolumeOpts)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiControllerServer).DeleteDockVolume(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ApiController/DeleteDockVolume",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiControllerServer).DeleteDockVolume(ctx, req.(*DeleteVolumeOpts))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiController_ExtendVolume_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExtendVolumeOpts)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiControllerServer).ExtendVolume(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ApiController/ExtendVolume",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiControllerServer).ExtendVolume(ctx, req.(*ExtendVolumeOpts))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiController_CreateVolumeSnapshot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateVolumeSnapshotOpts)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiControllerServer).CreateVolumeSnapshot(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ApiController/CreateVolumeSnapshot",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiControllerServer).CreateVolumeSnapshot(ctx, req.(*CreateVolumeSnapshotOpts))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiController_DeleteVolumeSnapshot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteVolumeSnapshotOpts)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiControllerServer).DeleteVolumeSnapshot(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ApiController/DeleteVolumeSnapshot",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiControllerServer).DeleteVolumeSnapshot(ctx, req.(*DeleteVolumeSnapshotOpts))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiController_CreateVolumeAttachment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateVolumeAttachmentOpts)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiControllerServer).CreateVolumeAttachment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ApiController/CreateVolumeAttachment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiControllerServer).CreateVolumeAttachment(ctx, req.(*CreateVolumeAttachmentOpts))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiController_DeleteVolumeAttachment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteVolumeAttachmentOpts)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiControllerServer).DeleteVolumeAttachment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ApiController/DeleteVolumeAttachment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiControllerServer).DeleteVolumeAttachment(ctx, req.(*DeleteVolumeAttachmentOpts))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiController_CreateReplication_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateReplicationOpts)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiControllerServer).CreateReplication(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ApiController/CreateReplication",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiControllerServer).CreateReplication(ctx, req.(*CreateReplicationOpts))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiController_DeleteReplication_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteReplicationOpts)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiControllerServer).DeleteReplication(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ApiController/DeleteReplication",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiControllerServer).DeleteReplication(ctx, req.(*DeleteReplicationOpts))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiController_EnableReplication_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EnableReplicationOpts)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiControllerServer).EnableReplication(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ApiController/EnableReplication",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiControllerServer).EnableReplication(ctx, req.(*EnableReplicationOpts))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiController_DisableReplication_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DisableReplicationOpts)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiControllerServer).DisableReplication(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ApiController/DisableReplication",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiControllerServer).DisableReplication(ctx, req.(*DisableReplicationOpts))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiController_FailoverReplication_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FailoverReplicationOpts)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiControllerServer).FailoverReplication(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ApiController/FailoverReplication",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiControllerServer).FailoverReplication(ctx, req.(*FailoverReplicationOpts))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiController_CreateVolumeGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateVolumeGroupOpts)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiControllerServer).CreateVolumeGroup(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ApiController/CreateVolumeGroup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiControllerServer).CreateVolumeGroup(ctx, req.(*CreateVolumeGroupOpts))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiController_UpdateVolumeGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateVolumeGroupOpts)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiControllerServer).UpdateVolumeGroup(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ApiController/UpdateVolumeGroup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiControllerServer).UpdateVolumeGroup(ctx, req.(*UpdateVolumeGroupOpts))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiController_DeleteVolumeGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteVolumeGroupOpts)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiControllerServer).DeleteVolumeGroup(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ApiController/DeleteVolumeGroup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiControllerServer).DeleteVolumeGroup(ctx, req.(*DeleteVolumeGroupOpts))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiController_GetMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMetricsOpts)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiControllerServer).GetMetrics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ApiController/GetMetrics",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiControllerServer).GetMetrics(ctx, req.(*GetMetricsOpts))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiController_CollectMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CollectMetricsOpts)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiControllerServer).CollectMetrics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ApiController/CollectMetrics",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiControllerServer).CollectMetrics(ctx, req.(*CollectMetricsOpts))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiController_GetUrls_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NoParams)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiControllerServer).GetUrls(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ApiController/GetUrls",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiControllerServer).GetUrls(ctx, req.(*NoParams))
	}
	return interceptor(ctx, in, info, handler)
}

var _ApiController_serviceDesc = grpc.ServiceDesc{
	ServiceName: "proto.ApiController",
	HandlerType: (*ApiControllerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CreateDockVolume",
			Handler:    _ApiController_CreateDockVolume_Handler,
		},
		{
			MethodName: "DeleteDockVolume",
			Handler:    _ApiController_DeleteDockVolume_Handler,
		},
		{
			MethodName: "ExtendVolume",
			Handler:    _ApiController_ExtendVolume_Handler,
		},
		{
			MethodName: "CreateVolumeSnapshot",
			Handler:    _ApiController_CreateVolumeSnapshot_Handler,
		},
		{
			MethodName: "DeleteVolumeSnapshot",
			Handler:    _ApiController_DeleteVolumeSnapshot_Handler,
		},
		{
			MethodName: "CreateVolumeAttachment",
			Handler:    _ApiController_CreateVolumeAttachment_Handler,
		},
		{
			MethodName: "DeleteVolumeAttachment",
			Handler:    _ApiController_DeleteVolumeAttachment_Handler,
		},
		{
			MethodName: "CreateReplication",
			Handler:    _ApiController_CreateReplication_Handler,
		},
		{
			MethodName: "DeleteReplication",
			Handler:    _ApiController_DeleteReplication_Handler,
		},
		{
			MethodName: "EnableReplication",
			Handler:    _ApiController_EnableReplication_Handler,
		},
		{
			MethodName: "DisableReplication",
			Handler:    _ApiController_DisableReplication_Handler,
		},
		{
			MethodName: "FailoverReplication",
			Handler:    _ApiController_FailoverReplication_Handler,
		},
		{
			MethodName: "CreateVolumeGroup",
			Handler:    _ApiController_CreateVolumeGroup_Handler,
		},
		{
			MethodName: "UpdateVolumeGroup",
			Handler:    _ApiController_UpdateVolumeGroup_Handler,
		},
		{
			MethodName: "DeleteVolumeGroup",
			Handler:    _ApiController_DeleteVolumeGroup_Handler,
		},
		{
			MethodName: "GetMetrics",
			Handler:    _ApiController_GetMetrics_Handler,
		},
		{
			MethodName: "CollectMetrics",
			Handler:    _ApiController_CollectMetrics_Handler,
		},
		{
			MethodName: "GetUrls",
			Handler:    _ApiController_GetUrls_Handler,
		},
	},
...
func (c *provisionDockClient) CreateDockVolume(ctx context.Context, in *CreateVolumeOpts, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ProvisionDock/CreateDockVolume", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *provisionDockClient) DeleteDockVolume(ctx context.Context, in *DeleteVolumeOpts, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
	err := c.cc.Invoke(ctx, "/proto.ProvisionDock/DeleteDockVolume", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedProvisionDockServer) CreateDockVolume(ctx context.Context, req *CreateVolumeOpts) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateDockVolume not implemented")
}
func (*UnimplementedProvisionDockServer) DeleteDockVolume(ctx context.Context, req *DeleteVolumeOpts) (*GenericResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteDockVolume not implemented")
}
...
func _ProvisionDock_CreateDockVolume_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateVolumeOpts)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProvisionDockServer).CreateDockVolume(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ProvisionDock/CreateDockVolume",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProvisionDockServer).CreateDockVolume(ctx, req.(*CreateVolumeOpts))
	}
	return interceptor(ctx, in, info, handler)
}

func _ProvisionDock_DeleteDockVolume_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteVolumeOpts)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProvisionDockServer).DeleteDockVolume(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ProvisionDock/DeleteDockVolume",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProvisionDockServer).DeleteDockVolume(ctx, req.(*DeleteVolumeOpts))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ProvisionDock_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CreateDockVolume",
			Handler:    _ProvisionDock_CreateDockVolume_Handler,
		},
		{
			MethodName: "DeleteDockVolume",
			Handler:    _ProvisionDock_DeleteDockVolume_Handler,
		},
		{
			MethodName: "ExtendVolume",
