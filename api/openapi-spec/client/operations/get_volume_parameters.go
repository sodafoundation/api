...
// WithResourceType adds the resourceType to the get volume params
func (o *GetVolumeParams) WithResourceType(resourceType string) *GetVolumeParams {
	o.SetResourceType(resourceType)
	return o
}

// SetResourceType adds the resourceType to the get volume params
func (o *GetVolumeParams) SetResourceType(resourceType string) {
